...
//go:generate sh -c "./mockgen_internal.sh mockhandshake handshake/aead_with_packet_number_crypto.go github.com/lucas-clemente/quic-go/internal/handshake AEADWithPacketNumberCrypto"
