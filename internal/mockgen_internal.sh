...
TEMP_DIR=$(mktemp -d)
mkdir -p $TEMP_DIR/src/github.com/wheelcomplex/qk/internalpackage
...
cp -r $GOPATH/src/github.com/wheelcomplex/qk/internal/* $TEMP_DIR/src/github.com/wheelcomplex/qk/internalpackage
